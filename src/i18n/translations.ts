...
export interface Translations {
  ui: {
    ...
    sumInstruction: (a: number, b: number) => string;
    skipPhase: string;
  };
...
export const translations: Record<Locale, Translations> = {
  pt: {
    ui: {
      ...
      phase2Name: "Bolhas Flutuantes",
      phase3Name: "Encontre o Grupo",
      phase4Name: "Desenhar o Número",
      phase5Name: "Soma com Animais",
      ...
      sumInstruction: (a, b) => `Quanto é ${a} mais ${b}?`,
      skipPhase: "Pular ⏭",
    },
    animalNames: {
  ...
  en: {
    ui: {
      ...
      phase2Name: "Floating Bubbles",
      phase3Name: "Find the Group",
      phase4Name: "Draw the Number",
      phase5Name: "Animal Sums",
      ...
      sumInstruction: (a, b) => `What is ${a} plus ${b}?`,
      skipPhase: "Skip ⏭",
    },
    animalNames: {
  ...
  es: {
    ui: {
      ...
      phase2Name: "Burbujas Flotantes",
      phase3Name: "Encuentra el Grupo",
      phase4Name: "Dibujar el Número",
      phase5Name: "Sumas con Animales",
      ...
      sumInstruction: (a, b) => `¿Cuánto es ${a} más ${b}?`,
      skipPhase: "Saltar ⏭",
    },
    animalNames: {
  ...
  fr: {
    ui: {
      ...
      phase2Name: "Bulles Flottantes",
      phase3Name: "Trouve le Groupe",
      phase4Name: "Dessiner le Chiffre",
      phase5Name: "Additions d'Animaux",
      ...
      sumInstruction: (a, b) => `Combien font ${a} plus ${b} ?`,
      skipPhase: "Passer ⏭",
    },
    animalNames: {
  ...
  it: {
    ui: {
      ...
      phase2Name: "Bolle Galleggianti",
      phase3Name: "Trova il Gruppo",
      phase4Name: "Disegna il Numero",
      phase5Name: "Somme con Animali",
      ...
      sumInstruction: (a, b) => `Quanto fa ${a} più ${b}?`,
      skipPhase: "Salta ⏭",
    },
    animalNames: {
  ...
  de: {
    ui: {
      ...
      phase2Name: "Schwebende Blasen",
      phase3Name: "Finde die Gruppe",
      phase4Name: "Zahl Nachzeichnen",
      phase5Name: "Tier-Additionen",
      ...
      sumInstruction: (a, b) => `Was ist ${a} plus ${b}?`,
      skipPhase: "Weiter ⏭",
    },
    animalNames: {
      galinha: "Huhn", vaca: "Kuh", porco: "Schwein", ovelha: "Schaf",
      cavalo: "Pferd", pato: "Ente", coelho: "Kaninchen", gato: "Katze",
      cachorro: "Hund", burro: "Esel", peru: "Truthahn", cabra: "Ziege",
      ganso: "Gans", hamster: "Hamster", papagaio: "Papagei", ponei: "Pony",
      leao: "Löwe", elefante: "Elefant", girafa: "Giraffe", macaco: "Affe",
      zebra: "Zebra", urso: "Bär", tigre: "Tiger", cobra: "Schlange",
      panda: "Panda", hipopotamo: "Nilpferd", canguru: "Känguru", koala: "Koala",
      preguica: "Faultier", raposa: "Fuchs", coruja: "Eule", camaleao: "Chamäleon",
      peixe: "Fisch", golfinho: "Delphin", polvo: "Krake", caranguejo: "Krabbe",
      tartaruga: "Schildkröte", baleia: "Wal", tubarao: "Hai", lula: "Tintenfisch",
      cavalo_marinho: "Seepferdchen", foca: "Robbe", pinguim: "Pinguin", arraia: "Rochen",
      morsa: "Walross", lontra: "Fischotter", estrela_do_mar: "Seestern", lagosta: "Hummer",
    ...
    narrateText: (count, animalName) => {
      const plurals: Record<string, string> = {
        ...
        cachorro: "Hunde", burro: "Esel", peru: "Truthähne", cabra: "Ziegen",
        ganso: "Gänse", hamster: "Hamster", papagaio: "Papageien", ponei: "Ponys",
        leao: "Löwen", elefante: "Elefanten", girafa: "Giraffen", macaco: "Affen",
        zebra: "Zebras", urso: "Bären", tigre: "Tiger", cobra: "Schlangen",
        panda: "Pandas", hipopotamo: "Nilpferde", canguru: "Kängurus", koala: "Koalas",
        preguica: "Faultiere", raposa: "Füchse", coruja: "Eulen", camaleao: "Chamäleons",
        ...
        cavalo_marinho: "Seepferdchen", foca: "Robben", pinguim: "Pinguine", arraia: "Rochen",
        morsa: "Walrosse", lontra: "Fischotter", estrela_do_mar: "Seesterne", lagosta: "Hummer",
      ...
      const singulars: Record<string, string> = {
        ...
        cachorro: "einen Hund", burro: "einen Esel", peru: "einen Truthahn", cabra: "eine Ziege",
        ganso: "eine Gans", hamster: "einen Hamster", papagaio: "einen Papagei", ponei: "ein Pony",
        ...
        panda: "einen Panda", hipopotamo: "ein Nilpferd", canguru: "ein Känguru", koala: "einen Koala",
        preguica: "ein Faultier", raposa: "einen Fuchs", coruja: "eine Eule", camaleao: "ein Chamäleon",
        ...
        cavalo_marinho: "ein Seepferdchen", foca: "eine Robbe", pinguim: "einen Pinguin", arraia: "einen Rochen",
        morsa: "ein Walross", lontra: "einen Fischotter", estrela_do_mar: "einen Seestern", lagosta: "einen Hummer",
