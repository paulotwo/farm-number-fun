...
const DOMESTIC_ANIMALS: Record<string, { name: string; image: string }> = {
  ...
  cachorro:  { name: "cachorro",  image: "/animals/domestic/cachorro.png" },
  burro:     { name: "burro",     image: "/animals/domestic/burro.png" },
  peru:      { name: "peru",      image: "/animals/domestic/peru.png" },
  cabra:     { name: "cabra",     image: "/animals/domestic/cabra.png" },
  ganso:     { name: "ganso",     image: "/animals/domestic/ganso.png" },
  hamster:   { name: "hamster",   image: "/animals/domestic/hamster.png" },
  papagaio:  { name: "papagaio",  image: "/animals/domestic/papagaio.png" },
  ponei:     { name: "pônei",     image: "/animals/domestic/ponei.png" },
};
...
const WILD_ANIMALS: Record<string, { name: string; image: string }> = {
  ...
  panda:      { name: "panda",      image: "/animals/wild/panda.png" },
  hipopotamo: { name: "hipopótamo", image: "/animals/wild/hipopotamo.png" },
  canguru:    { name: "canguru",    image: "/animals/wild/canguru.png" },
  koala:      { name: "coala",      image: "/animals/wild/koala.png" },
  preguica:   { name: "preguiça",   image: "/animals/wild/preguica.png" },
  raposa:     { name: "raposa",     image: "/animals/wild/raposa.png" },
  coruja:     { name: "coruja",     image: "/animals/wild/coruja.png" },
  camaleao:   { name: "camaleão",   image: "/animals/wild/camaleao.png" },
};
...
const AQUATIC_ANIMALS: Record<string, { name: string; image: string }> = {
  ...
  cavalo_marinho: { name: "cavalo-marinho", image: "/animals/aquatic/cavalo_marinho.png" },
  foca:          { name: "foca",          image: "/animals/aquatic/foca.png" },
  pinguim:       { name: "pinguim",       image: "/animals/aquatic/pinguim.png" },
  arraia:        { name: "arraia",        image: "/animals/aquatic/arraia.png" },
  morsa:         { name: "morsa",         image: "/animals/aquatic/morsa.png" },
  lontra:        { name: "lontra",        image: "/animals/aquatic/lontra.png" },
  estrela_do_mar: { name: "estrela-do-mar", image: "/animals/aquatic/estrela_do_mar.png" },
  lagosta:       { name: "lagosta",       image: "/animals/aquatic/lagosta.png" },
};
